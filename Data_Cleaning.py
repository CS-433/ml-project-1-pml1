...
def filter_data(X,col,angle_col,model,_type_="default",standardize = True, prediction = False, mean_transformation = None,
    ...
    """
    This function is used to filter the data once it has been separated into three subsets.
    
    Arguments:  
        - X: subset of the initial dataset
        - col: list of the columns which will not have missing data for this subset of data
        - angle_col: list of the columns which are angle
        - _type_: str name of the model to generate
        - standardize: boolean to know if we should normalize the data after transformation
        - other parameter: rescale the data as during the training for the submission
